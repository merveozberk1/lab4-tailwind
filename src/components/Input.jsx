    ...
    <div className="space-y-1 text-left w-full">
      ...
      <input
        ...
        className={`w-full px-3 py-2 rounded-lg border transition-colors focus:outline-none focus:ring-2 dark:text-gray-100 ${
          error
            ? "border-red-500 focus:ring-red-500 dark:bg-gray-800"
            : "border-gray-300 focus:ring-blue-500 dark:bg-gray-800"
        } ${
          disabled
            ? "bg-gray-100 cursor-not-allowed opacity-70 dark:bg-gray-900 dark:border-gray-700"
            : "bg-white"
        }`}
